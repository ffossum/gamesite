...
function getHeadContent() {
  if (__DEVELOPMENT__) {
    return '<script src="http://localhost:3000/dist/main.js" defer></script>';
  }
  const assets = JSON.parse(fs.readFileSync('dist/webpack-assets.json', 'utf8'));
  return `
    <link rel="stylesheet" href="${assets.main.css}"></link>
    <script src="https://cdn.jsdelivr.net/react/15.4.2/react-with-addons.min.js" defer></script>
    <script src="https://cdn.jsdelivr.net/react/15.4.2/react-dom.min.js" defer></script>
